...
namespace Controller
{
    ...
    public class TaskController
    {
        ...
        public List<(int,string)> getTasksByStatus(string Status)
        {
            ...
            switch(Status){
                ...
                case "In-Progress":
                    allTasks=allTasks.Where(t=>t.Status=="In-Progress").ToList();
                    break; 

                case "Done": 
                    allTasks=allTasks.Where(t=>t.Status=="Done").ToList();
                    break; 
            ...
            if(allTasks.Count!=0){
                ...
                foreach(var task in allTasks)
                {
                    var taskData=(task.Id,task.Description); 
                    taskList.Add(taskData); 
                }
            }
            return taskList;
